import svgPaths from "./svg-ocxynt7rra";
...
function NavBar() {
  return (
    <div className="bg-[#eaf2ff] h-[57px] overflow-clip relative shrink-0 w-full" data-name="Nav Bar">
      <ArrowLeft />
      <p className="-translate-x-1/2 absolute css-ew64yg font-['Inter:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold leading-[normal] left-1/2 not-italic text-[#1f2024] text-[14px] text-center top-[calc(50%-8px)]">今日の質問 ２問挑戦！</p>
    </div>
  );
}
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[327px]" data-name="質問入力フレーム">
      <TextArea />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="h-[1081px] relative shrink-0 w-full">
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col h-[1081px] items-start left-0 top-[101px] w-[375px]">
      <Frame4 />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="今日の質問２">
      <Action />
      <IOsStatusBar />
      <Component1 />
      <Frame6 />
