import svgPaths from "./svg-l5u3zthrb2";
...
function Frame25() {
  return (
    <div className="relative shrink-0 size-[40.488px]">
      <div className="absolute inset-[0_0_-51.37%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4884 61.2883">
          <g id="Frame 110">
            <g id="Group 1">
              <circle cx="20.2442" cy="20.2442" fill="var(--fill-0, #71727A)" id="Ellipse 2" r="20.2442" />
              <g clipPath="url(#clip0_1_2952)" id="octicon:smiley-neutral-16">
                <path d={svgPaths.p3689bc00} fill="var(--fill-0, white)" id="Vector" />
              </g>
            </g>
            <ellipse cx="20.4346" cy="50.7883" fill="var(--fill-0, #2897FF)" id="Ellipse 8" rx="13.5" ry="10.5" />
          </g>
          <defs>
...
function DaysOfTheMonth23() {
  return (
    <div className="content-stretch flex h-[40px] items-center justify-center relative rounded-[24.67px] shrink-0 w-[40.09px]" data-name=".Days of the month">
      <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[14.802px] text-center text-white">21</p>
    </div>
  );
}
...
function Plan1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[21px] items-center min-h-px min-w-px relative" data-name="Plan">
      <Group3 />
      <p className="css-4hzbpn font-['Inter:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#1f2024] text-[14px] w-[194px]">2026年 1月 21日 (水)　２問</p>
    </div>
  );
}
...
function Title() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center not-italic relative shrink-0 text-[#1f2024] w-[293px]" data-name="Title">
      <p className="css-4hzbpn font-['Inter:Extra_Bold','Noto_Sans_JP:Black',sans-serif] font-extrabold leading-[normal] min-w-full relative shrink-0 text-[18px] tracking-[0.09px] w-[min-content]">Q1. 今日一番美味しかったものは？</p>
      <p className="css-ew64yg font-['Inter:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[16px]">チゲうどん</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex h-[57px] items-start justify-between relative shrink-0 w-full">
      <Title />
    </div>
  );
}
...
function Component17() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] h-[134px] items-start relative shrink-0 w-[292px]" data-name="質問回答">
      <Frame />
      <p className="css-4hzbpn font-['Inter:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal h-[72px] leading-[16px] not-italic relative shrink-0 text-[#71727a] text-[12px] tracking-[0.12px] w-full">安売りしてて大量買いしたチゲうどんを早速昼ご飯に食べた。安くて美味しいが正義だよね。ただあの量はいずれ飽きかねないから、アレンジを考えた方が良いと思った。</p>
    </div>
  );
}
...
function Title1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center not-italic relative shrink-0 text-[#1f2024] w-[293px]" data-name="Title">
      <p className="css-4hzbpn font-['Inter:Extra_Bold','Noto_Sans_JP:Black',sans-serif] font-extrabold leading-[normal] relative shrink-0 text-[18px] tracking-[0.09px] w-[293px]">Q2. 今日の部屋の散らかり度を1～10で表してみて</p>
      <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[16px]">7</p>
    </div>
  );
}
...
function Component18() {
  return (
    <div className="content-stretch flex flex-col gap-[44px] h-[142px] items-start relative shrink-0 w-[292px]" data-name="質問回答">
      <Frame1 />
      <p className="css-4hzbpn font-['Inter:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal h-[70px] leading-[16px] not-italic relative shrink-0 text-[#71727a] text-[12px] tracking-[0.12px] w-full">取り敢えずパソコンを出して作業ができる空間だけはある。それ以外が壊滅的なので、この作業が終わったらまずは部屋の片づけをしたいと思う。</p>
    </div>
  );
}
...
function Component16() {
  return (
    <div className="absolute bg-[#eaf2ff] content-stretch flex flex-col gap-[11px] h-[374px] items-start left-[24px] pb-[16px] pt-[7px] px-[16px] rounded-[16px] top-[568px] w-[327px]" data-name="詳細表示">
      <Plan />
      <ProgressBar />
      <Component17 />
      <Component18 />
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="ダイアログ（詳細表示）">
      <TabBar />
      <NavBar />
      <MonthlyCalendar />
      <Component16 />
