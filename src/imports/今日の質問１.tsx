import svgPaths from "./svg-f2rq7vxjus";
...
function NavBar() {
  return (
    <div className="bg-[#eaf2ff] h-[53px] overflow-clip relative shrink-0 w-full" data-name="Nav Bar">
      <ArrowLeft />
      <p className="-translate-x-1/2 absolute css-ew64yg font-['Inter:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold leading-[normal] left-1/2 not-italic text-[#1f2024] text-[14px] text-center top-[calc(50%-8px)]">今日の質問 １問挑戦！</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 top-[44px] w-[375px]">
      <NavBar />
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[245px] items-start relative shrink-0 w-full" data-name="Text Area">
      <Field1 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[369px] items-start relative shrink-0 w-full">
      <div className="font-['Inter:Extra_Bold','Noto_Sans_JP:Black',sans-serif] font-extrabold h-[44px] leading-[normal] not-italic relative shrink-0 text-[#1f2024] text-[18px] text-center tracking-[0.09px] w-full">
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] h-[118px] items-start relative shrink-0 w-full">
      <Frame />
      <FaceRating />
    </div>
  );
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[59px] h-[594px] items-start left-0 p-[24px] right-0 top-[97px]">
      <Frame2 />
      <button className="block cursor-pointer font-['Inter:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold h-[15px] leading-[0] not-italic relative shrink-0 text-[#494a50] text-[12px] text-center w-full">
        <p className="css-4hzbpn">
          <span className="leading-[normal]">もし「今日はもっと答えれる」なら</span>
          <span className="leading-[normal] text-[#2897ff]">ここ</span>
          <span className="leading-[normal]">をタップ！</span>
        </p>
      </button>
      <Frame1 />
    </div>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="今日の質問１">
      <Action />
      <IOsStatusBar />
      <Frame4 />
      <Frame3 />
